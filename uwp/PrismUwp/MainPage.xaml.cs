...
namespace PrismUwp
{
    ...
    /// `npm run uwp:sync`) full-screen inside a WebView2 control.
    ///
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private const string VirtualHostName = "prismuwp.local";
        private const string InitialUri = "https://prismuwp.local/index.html";
