...
# nothing in the PrismUwpEffects.csproj build recompiles them automatically, matching this
...
Write-Host "Done. Re-add the .cso files as EmbeddedResource in PrismUwpEffects.csproj if this is their first build."
